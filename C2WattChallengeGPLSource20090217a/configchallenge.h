...
*/
#ifndef CONFIGCHALLENGE_H_
#define CONFIGCHALLENGE_H_

#include <QDialog>
#include "ui_configchallenge.h"

class ConfigChallengeDialog : public QDialog, public Ui_ConfigChallengeDialog {
  Q_OBJECT

  public:
    ConfigChallengeDialog(QWidget *parent = 0);
