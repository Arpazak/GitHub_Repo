...
*/
#ifndef STARTCHALLENGE_H_
#define STARTCHALLENGE_H_

#include <QDialog>
#include "ui_startchallenge.h"

class StartChallengeDialog : public QDialog, public Ui_StartChallengeDialog {
  Q_OBJECT

  public:
    StartChallengeDialog(QWidget *parent = 0);
};
