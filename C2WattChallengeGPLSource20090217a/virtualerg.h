...
*/
#ifndef VIRTUALERG_H_
#define VIRTUALERG_H_

#include <QDialog>
#include "ui_virtualerg.h"

class VirtualErgDialog : public QDialog, public Ui_VirtualErg {
  Q_OBJECT

  public:
    VirtualErgDialog(QWidget *parent = 0);
};
